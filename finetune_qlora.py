...
output_dir = "finetuned_model_qlora"
...
plt.xlabel('Epoch')
plt.legend()
plt.title('QLoRA Training Metrics + Eval Perplexity & Accuracy')
plt.savefig('training_metrics_qlora.png')
print("All metrics plotted and saved as training_metrics_qlora.png")